...
public class ClassFile {
	 ...
	 */
	static byte[] stackGrowth;
	static {
		try {
			stackGrowth = "\u0000\u0001\u0001\u0001\u0001\u0001\u0001\u0001\u0001\u0002\u0002\u0001\u0001\u0001\u0002\u0002\u0001\u0001\u0001\u0001\u0002\u0001\u0002\u0001\u0002\u0001\u0001\u0001\u0001\u0001\u0002\u0002\u0002\u0002\u0001\u0001\u0001\u0001\u0002\u0002\u0002\u0002\u0001\u0001\u0001\u0001\u00FF\u0000\u00FF\u0000\u00FF\u00FF\u00FF\u00FF\u00FF\u00FE\u00FF\u00FE\u00FF\u00FF\u00FF\u00FF\u00FF\u00FE\u00FE\u00FE\u00FE\u00FF\u00FF\u00FF\u00FF\u00FE\u00FE\u00FE\u00FE\u00FF\u00FF\u00FF\u00FF\u00FD\u00FC\u00FD\u00FC\u00FD\u00FD\u00FD\u00FD\u00FF\u00FE\u0001\u0001\u0001\u0002\u0002\u0002\u0000\u00FF\u00FE\u00FF\u00FE\u00FF\u00FE\u00FF\u00FE\u00FF\u00FE\u00FF\u00FE\u00FF\u00FE\u00FF\u00FE\u00FF\u00FE\u00FF\u00FE\u0000\u0000\u0000\u0000\u00FF\u00FF\u00FF\u00FF\u00FF\u00FF\u00FF\u00FE\u00FF\u00FE\u00FF\u00FE\u0000\u0001\u0000\u0001\u00FF\u00FF\u0000\u0000\u0001\u0001\u00FF\u0000\u00FF\u0000\u0000\u0000\u00FD\u00FF\u00FF\u00FD\u00FD\u00FF\u00FF\u00FF\u00FF\u00FF\u00FF\u00FE\u00FE\u00FE\u00FE\u00FE\u00FE\u00FE\u00FE\u0000\u0000\u0000\u00FF\u00FF\u00FF\u00FE\u00FF\u00FE\u00FF\u0000\u0000\u0000\u00FF\u00FF\u00FF\u00FF\u0000\u00FF\u0000\u0001\u0000\u0000\u0000\u00FF\u0000\u0000\u00FF\u00FF\u0000\u0001\u00FF\u00FF\u0000\u0001\u0000\u0001\u0001\u0002\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0001\u0001\u00FF\u0000\u0000\u0000\u0000"
					.getBytes("ISO-8859-1");
		} catch (Exception e) {
			stackGrowth = null;
		}
	...
	/*
	 * static final byte[] stackGrowth = { 0, // nop 1, // aconst_null 1, //
	 * iconst_m1 1, // iconst_0 1, // iconst_1 1, // iconst_2 1, // iconst_3 1,
	 * // iconst_4 1, // iconst_5 2, // lconst_0 2, // lconst_1 1, // fconst_0
	 * 1, // fconst_1 1, // fconst_2 2, // dconst_0 2, // dconst_1 1, // bipush
	 * 1, // sipush 1, // ldc 1, // ldc_W 2, // ldc2_W 1, // iload 2, // lload
	 * 1, // fload 2, // dload 1, // aload 1, // iload_0 1, // iload_1 1, //
	 * iload_2 1, // iload_3 2, // lload_0 2, // lload_1 2, // lload_2 2, //
	 * lload_3 1, // fload_0 1, // fload_1 1, // fload_2 1, // fload_3 2, //
	 * dload_0 2, // dload_1 2, // dload_2 2, // dload_3 1, // aload_0 1, //
	 * aload_1 1, // aload_2 1, // aload_3 -1, // iaload 0, // laload -1, //
	 * faload 0, // daload -1, // aaload -1, // baload -1, // caload -1, //
	 * saload -1, // istore -2, // lstore -1, // fstore -2, // dstore -1, //
	 * astore -1, // istore_0 -1, // istore_1 -1, // istore_2 -1, // istore_3
	 * -2, // lstore_0 -2, // lstore_1 -2, // lstore_2 -2, // lstore_3 -1, //
	 * fstore_0 -1, // fstore_1 -1, // fstore_2 -1, // fstore_3 -2, // dstore_0
	 * -2, // dstore_1 -2, // dstore_2 -2, // dstore_3 -1, // astore_0 -1, //
	 * astore_1 -1, // astore_2 -1, // astore_3 -3, // iastore -4, // lastore
	 * -3, // fastore -4, // dastore -3, // aastore -3, // bastore -3, //
	 * castore -3, // sastore -1, // pop -2, // pop2 1, // dup 1, // dup_X1 1,
	 * // dup_X2 2, // dup2 2, // dup2_X1 2, // dup2_X2 0, // swap -1, // iadd
	 * -2, // ladd -1, // fadd -2, // dadd -1, // isub -2, // lsub -1, // fsub
	 * -2, // dsub -1, // imul -2, // lmul -1, // fmul -2, // dmul -1, // idiv
	 * -2, // ldiv -1, // fdiv -2, // ddiv -1, // irem -2, // lrem -1, // frem
	 * -2, // drem 0, // ineg 0, // lneg 0, // fneg 0, // dneg -1, // ishl -1,
	 * // lshl -1, // ishr -1, // lshr -1, // iushr -1, // lushr -1, // iand -2,
	 * // land -1, // ior -2, // lor -1, // ixor -2, // lxor 0, // iinc 1, //
	 * i2l 0, // i2f 1, // i2d -1, // l2i -1, // l2f 0, // l2d 0, // f2i 1, //
	 * f2l 1, // f2d -1, // d2i 0, // d2l -1, // d2f 0, // i2b 0, // i2c 0, //
	 * i2s -3, // lcmp -1, // fcmpl -1, // fcmpg -3, // dcmpl -3, // dcmpg -1,
	 * // ifeq -1, // ifne -1, // iflt -1, // ifge -1, // ifgt -1, // ifle -2,
	 * // if_icmpeq -2, // if_icmpne -2, // if_icmplt -2, // if_icmpge -2, //
	 * if_icmpgt -2, // if_icmple -2, // if_acmpeq -2, // if_acmpne 0, // goto
	 * 0, // jsr 0, // ret -1, // tableswitch -1, // lookupswitch -1, // ireturn
	 * -2, // lreturn -1, // freturn -2, // dreturn -1, // areturn 0, // return
	 * 0, // getstatic 0, // putstatic -1, // getfield -1, // putfield -1, //
	 * invokevirtual -1, // invokespecial 0, // invokestatic -1, //
	 * invokeinterface 0, // UNUSED 1, // new 0, // newarray 0, // anewarray 0,
	 * // arraylength -1, // athrow 0, // checkcast 0, // instanceof -1, //
	 * monitorenter -1, // monitorexit 0, // wide 1, // multianewarray -1, //
	 * ifnull -1, // ifnonnull 0, // goto_w 1, // jsr_w 0, // breakpoint 1, //
	 * ldc_quick 1, // ldc_w_quick 2, // ldc2_w_quick 0, // getfield_quick 0, //
	 * putfield_quick 0, // getfield2_quick 0, // putfield2_quick 0, //
	 * getstatic_quick 0, // putstatic_quick 0, // getstatic2_quick 0, //
	 * putstatic2_quick 0, // invokevirtual_quick 0, // invokenonvirtual_quick
	 * 0, // invokesuper_quick 0, // invokestatic_quick 0, //
	 * invokeinterface_quick 0, // invokevirtualobject_quick 0, // UNUSED 1, //
	 * new_quick 1, // anewarray_quick 1, // multianewarray_quick -1, //
	 * checkcast_quick 0, // instanceof_quick 0, // invokevirtual_quick_w 0, //
	 * getfield_quick_w 0 // putfield_quick_w };
	 */
	...
	private List<Short> interfaces = new ArrayList<Short>();
	...
	static {
		try {
			...
			defaultMajorVersion = 0x31;
		} catch (Exception e) {
			defaultMajorVersion = 0x30;
		}
	}

	public ClassFile(String thisClass, String superClass, String sourceFile,
			short accessFlags) {
		this(thisClass, superClass, sourceFile, accessFlags,
				defaultMajorVersion, 0);
	}

	public ClassFile(String thisClass, String superClass, String sourceFile,
			short accessFlags, int majorVersion, int minorVersion) {
	...
	public void addField(String fieldName, String type, short accessFlags) {
		fields.add(new FieldInfo(constantPool.addUTF8(fieldName), constantPool
				.addUTF8(type), accessFlags));
	}
	...
	public short addClass(String value) {
		return constantPool.addClass(value);
	}
	...
	public void addConstant(String fieldName, String type, short flags,
		...
		cvAttr[2] = 2;
		cvAttr[3] = valueIndex;
		fields.add(new FieldInfo(fieldNameIndex, typeIndex, flags, cvAttr));
	}
	...
	public void closeMethod() {
		...
		if (exceptionSize > 0) {
			...
			/*
			 * for (Enumeration e = exceptionTable.elements();
			 * e.hasMoreElements();) { ExceptionTableEntry entry =
			 * (ExceptionTableEntry) e .nextElement();
			 * codeAttr.add(entry.start.getPC());
			 * codeAttr.add(entry.end.getPC());
			 * codeAttr.add(entry.handler.getPC());
			 * codeAttr.add(entry.catchType); }
	...
	public void shift(int offset) {
		if (exceptionTable != null) {
			for (int i = 0, n = exceptionTable.size(); i < n; i++) {
				ExceptionTableEntry entry = (ExceptionTableEntry) exceptionTable
						.get(i);
	...
	void pushLargeString(String str) {
		...
		for (int i = 0; i < n; i++) {
			...
			add(Opcode.INVOKEVIRTUAL, "java.lang.StringBuffer", "append",
		...
		add(Opcode.INVOKEVIRTUAL, "java.lang.StringBuffer", "toString", "()",
				"Ljava/lang/String;");
	}
	...
	public void write(OutputStream stream) throws IOException {
		...
		for (int i = 0; i < interfaces.size(); i++) {
			out.writeShort(interfaces.get(i).shortValue());
		}
